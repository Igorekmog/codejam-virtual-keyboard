const Keyboard = {
    ...
    init() {
        ...
        this.elements.inputBlock = document.createElement("textarea");

        // Setup main elements
        this.elements.inputBlock.classList.add("input-block");
        ...
        this.elements.wrapper.appendChild(this.elements.inputBlock);
